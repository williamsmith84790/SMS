                ...
                if ($notices_result && $notices_result->num_rows > 0) {
                    while($notice = $notices_result->fetch_assoc()) {
                        ...
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h6 class="mb-1 text-primary">
                                    ...
                                    <?php if(!empty($notice['link'])): ?>
                                        <a href="<?php echo htmlspecialchars($notice['link']); ?>" target="_blank" class="text-decoration-none"><?php echo htmlspecialchars($notice['title']); ?> <i class="fas fa-external-link-alt small"></i></a>
                                    <?php else: ?>
                            ...
                            <?php endif; ?>
                            <?php if(!empty($notice['link'])): ?>
                                <a href="<?php echo htmlspecialchars($notice['link']); ?>" class="badge bg-info text-dark text-decoration-none" target="_blank">Visit Link</a>
                            <?php endif; ?>
                        </div>
                        <?php
                    }
